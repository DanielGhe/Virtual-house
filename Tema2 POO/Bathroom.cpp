...
void Bathroom::createRoom(int number)  {
	string path = "Bathroom" + to_string(number) + ".txt";
	ofstream file(path);
...
void Bathroom::deleteRoom(int number) {
...
void Bathroom::updateRoom(int number) {
	...
	file << "Bathroom"+ to_string(number)+ " ";
...
void Bathroom::readRoom(int number) {
	string path = "Bathroom" + to_string(number) + ".txt";
	ifstream file;
	string room;
	double t, h, p;
