...
void Bedroom::createRoom(int number) {
	string path = "Bedroom" + to_string(number) + ".txt";
	ofstream file(path);
...
void Bedroom::deleteRoom(int number) {
...
void Bedroom::updateRoom(int number) {
...
void Bedroom::readRoom(int number) {
	string path = "Bedroom" + to_string(number) + ".txt";
	ifstream file;
	string room;
	double t, h, p;
